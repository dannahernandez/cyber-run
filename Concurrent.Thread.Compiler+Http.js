...
(function(){
    ...
    if ( this.Data.Error.newErrorClass === undefined ) this.Data.Error.newErrorClass = undefined;
    if ( this.Data.Error.Exception === undefined ) this.Data.Error.Exception = undefined;
    if ( this.Data.Error.newExceptionClass === undefined ) this.Data.Error.newExceptionClass = undefined;
with ( function(){
...
function newExceptionClass ( name, init ) {
    ...
    return c;
            ...
            return {
                newExceptionClass: newExceptionClass, Exception: Exception, newErrorClass: newErrorClass
            };
        }();
    }.call(null) ) {
    this.Data.Error.newExceptionClass = newExceptionClass;
    this.Data.Error.Exception = Exception;
    this.Data.Error.newErrorClass = newErrorClass;
}
}).call(null);
(function(){
    if ( !this.Data || (typeof this.Data != 'object' && typeof this.Data != 'function') ) this.Data = new Object();
...
(function(){
    if ( !this.Data || (typeof this.Data != 'object' && typeof this.Data != 'function') ) this.Data = new Object();
    if ( !this.Data.Error || (typeof this.Data.Error != 'object' && typeof this.Data.Error != 'function') ) this.Data.Error = new Object();
    if ( this.Data.Error.NotImplementedError === undefined ) this.Data.Error.NotImplementedError = undefined;
with ( function(){
with ( Data.Error ) {
...
proto.toString = function ( ) {
    ...
    this.Data.Error.NotImplementedError = NotImplementedError;
}
}).call(null);
(function(){
    if ( !this.Data || (typeof this.Data != 'object' && typeof this.Data != 'function') ) this.Data = new Object();
...
Thread.create = function ( f /* , ... */ ) {
    console.log("EStoy en el metodo crear");
...
function prepareTree ( f ) {
    ...
    */
            ...
            return {
                compile: compile, CACHE_LIMIT: CACHE_LIMIT, prepareTree: prepareTree, prepare: prepare
            };
        }();
    }
}
    ...
    this.Concurrent.Thread.CACHE_LIMIT = CACHE_LIMIT;
